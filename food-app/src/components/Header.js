...
import { changeLogin, setlogerDetails } from "../redux/slice/loginSlice";
     ...
     return(<>
        ...
        <div className="navleftlast">
           <ul className="navbar-nav  navfont   ">
              {isLogin==true ?(<li > <Link to={'/'} onClick={logout}><button className="btn btn-danger" type="button">Logout</button></Link></li>):(<li className="nav-item active "> <Link to={'/Login/header/id'}><button type="button" className="btn btn-danger"
